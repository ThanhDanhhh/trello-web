...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'TylerDangDev MERN Stack Board',
    ...
    columns: [
      ...
      },
      {
        ...
        /**
          * Cách xử lý bug logic thư iện Dnd-kit khi column là rỗng:
          ...
          * "columnId-placeholder-card" (mỗi column thì chỉ có tối đa một cái Placeholder Card)
